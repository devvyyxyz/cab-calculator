...
function getSocialIcon(platform: string): React.ReactNode {
  const iconClass = "h-8 w-8 transition-transform duration-300 group-hover:scale-110";

  switch (platform) {
    case "discord":
      return (
        <svg className={iconClass} viewBox="0 0 24 24" fill="#5865F2">
