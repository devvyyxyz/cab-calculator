...
export function ShareButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="btn-follow flex items-center gap-1.5 rounded-full px-3 py-2 text-[11px] font-bold text-white transition-all enabled:hover:scale-105 enabled:active:translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-40"
      style={{
